...
ADVENTURE_LEVELS: Tuple[AdventureLevelSpec, ...] = (
    ...
    _level("5-8", "roof", "peashooter sunflower wallnut potato_mine snowpea cherrybomb repeater chomper squash jalapeno puff_shroom sun_shroom fume_shroom grave_buster hypno_shroom scaredy_shroom ice_shroom doom_shroom tall_nut torchwood lily_pad tangle_kelp threepeater sea_shroom spikeweed split_pea cattail pumpkin magnet_shroom starfruit cactus plantern blover garlic coffee_bean umbrella_leaf marigold melon_pult kernel_pult cabbage_pult flower_pot winter_melon spikerock cob_cannon gloom_shroom gatling gold_magnet imitater", "normal conehead buckethead screen_door bungee ladder catapult football gargantuar imp", "gargantuar", "", 365, 225, T5),
    _level("5-9", "roof", "peashooter sunflower wallnut potato_mine snowpea cherrybomb repeater chomper squash jalapeno puff_shroom sun_shroom fume_shroom grave_buster hypno_shroom scaredy_shroom ice_shroom doom_shroom tall_nut torchwood lily_pad tangle_kelp threepeater sea_shroom spikeweed split_pea cattail pumpkin magnet_shroom starfruit cactus plantern blover garlic coffee_bean umbrella_leaf marigold melon_pult kernel_pult cabbage_pult flower_pot winter_melon spikerock cob_cannon gloom_shroom gatling gold_magnet twin_sunflower imitater", "normal conehead buckethead screen_door bungee ladder catapult football gargantuar imp", "gargantuar", "", 394, 250, T5),
